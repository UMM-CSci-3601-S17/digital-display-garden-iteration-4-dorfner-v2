...
//        Gson gson = new Gson();
        ...
        String plant1 = plantController.getPlantByPlantID("16001.0", "first uploadId");
        String expect2 = "{ \"_id\" : { \"$oid\" : \"58d1c36efb0cac4e15afd203\" }, \"commonName\" : \"Begonia\", \"cultivar\" : \"Megawatt Rose Green Leaf\" }";
        String plant2 = plantController.getPlantByPlantID("16008.0", "first uploadId");
        String expect3 = "{ \"_id\" : { \"$oid\" : \"58d1c36efb0cac4e15afd204\" }, \"commonName\" : \"Dianthus\", \"cultivar\" : \"Jolt™ Pink F1\" }";
        String plant3 = plantController.getPlantByPlantID("16040.0", "second uploadId");
    ...
    public void GetPlantByPlantIdDE() throws IOException {
        String plant1 = plantController.getPlantByPlantID("16001.0", "second uploadId");
        String plant2 = plantController.getPlantByPlantID("16008.0", "second uploadId");
        String plant3 = plantController.getPlantByPlantID("16040.0", "first uploadId");
