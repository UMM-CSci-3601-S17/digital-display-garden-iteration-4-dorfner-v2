...
//        return JSON.serialize(plantCollection.distinct("uploadId","".getClass()));
    ...
    /**
     * Returns a Bson object generated by the given ArrayList of sorting fieldnames.
     * The Bson object sorts by the criteria in ascending order.
     * @param criteria - an ArrayList of Strings which are sorting filters
     * @return a Bson object with sorting criteria
     */
